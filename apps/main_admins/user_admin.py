...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ("Accesses", {"fields": ("is_admin", "is_active", "is_superuser", "groups")}),
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ("username", "email", "national_code", "user_type", "password1", "password2", "is_superuser", "is_admin", "is_active")}
        ),
    )
